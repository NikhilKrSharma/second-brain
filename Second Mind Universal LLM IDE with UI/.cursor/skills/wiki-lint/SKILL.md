---
name: wiki-lint
description: Health-check the LLM Wiki for structural and semantic issues. Use when the user asks to lint or audit wiki quality.
---
...
5. Contradictions - claims that conflict between pages
6. Stale notes - pages not updated after newer sources changed the picture
7. Data gaps - important questions the wiki can't answer; suggest specific sources to find
8. Response style drift - run `python tools/style_lint.py` and include findings
